...
class Trainer(object):
    ...
    def train(self):
        ...
        # -------------------Tensorboard-------------------#
        writer = SummaryWriter('../runs/tensorboardx')
        epoch = 1
        epoch_losses = []
        #--------------------Tensorboard-------------------#
        ...
        for iteration, (images, targets, _) in enumerate(self.train_loader):
            ...
            if not self.args.skip_val and iteration % val_per_iters == 0:
                ...
                #------------------Tensorboard--------------------#
                writer.add_scalar('loss', sum(epoch_losses)/len(epoch_losses), global_step=epoch)
                self.validation(writer, epoch)
                epoch += 1
                epoch_losses = []
                #------------------Tensorboard--------------------#
    ...
    def validation(self, writer, epoch):
        ...
        writer.add_scalar('Pixel Accuracy', pixAcc, global_step = epoch)
        #------------------Tensorboard------------------#
